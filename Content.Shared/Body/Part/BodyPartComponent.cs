...
[Access(typeof(BodySystem), typeof(SharedSurgerySystem), typeof(SharedLimbSystem))] // Sunrise-edit
public sealed partial class BodyPartComponent : Component
{
    ...
    private List<ContainerSlot> BodyPartSlotsVV
    {
        get
        {
            ...
            {
                temp.Add((ContainerSlot) containerSystem.GetContainer(Owner, BodySystem.PartSlotContainerIdPrefix+slotId));
            }
    ...
    private List<ContainerSlot> OrganSlotsVV
    {
        get
        {
            ...
            {
                temp.Add((ContainerSlot) containerSystem.GetContainer(Owner, BodySystem.OrganSlotContainerIdPrefix+slotId));
            }
